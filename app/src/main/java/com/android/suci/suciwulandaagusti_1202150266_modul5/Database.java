...
public class Database extends SQLiteOpenHelper {
    ...
    public boolean inputdata(AddData list) {
        //mengatur kolom beserta nilainya
    ...
    //method yang digunakan untuk menghapus data pada database
    public boolean removedata(String ToDo) {
        return db.delete(nama_tabel, kolom_1+"=\""+ToDo+"\"", null)>0;
    }

    //method yang digunakan untuk mengakses dan membaca data dari database
