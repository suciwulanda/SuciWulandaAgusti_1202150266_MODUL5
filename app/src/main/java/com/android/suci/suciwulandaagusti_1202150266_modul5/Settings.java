...
public class Settings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //mengatur shape color dengan color id
    ...
    public void pilihWarna(View view) {
        //mengatur title dari alert dialog menjadi Shape Color
        ...
        //kondisi ketika menekan Ok pada alert dialog
        alert.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                //mendapatkan id radio button yang telah di pilih
                ...
                //mengatur shape color menjadi color id yang dipilih
                warna.setText(getShapeColor(colorid));
